...
let languages = new LocalizedStrings({
  en:{
    ...
    training_about_pdc: "Training & About PDC",
    explore_more: "Explore more",
    activities_explore: "Activities & Explore more",
  ...
  ps:{
    ...
    publishedresearches: "نشر سوي څیړني",
    ...
    policies_counsel: "تګلارې او مشورې",
    resourses: "منابع",
    support_services: "ملاتړی خدمتونه",
    enrollment_information: "د شمولیت معلومات",
    guidance_general: "لارښوونه او عمومي معلومات",
    guidelines: "لارښودنې",
    institutions: "ادارې",
    latest_posts: "وروستي پوسټونه",
    ...
    explore_more: " نور وپلټئ",
    activities_explore: "فعالیتونه او نور وپلټئ",
    activities_resources: " فعالیتونه او منابع",
    quality_accreditation: "تضمین کیفیت او اعتبار اخیستنه",
    achievements_progress: "پرمختګ او لاسته راوړنې",
