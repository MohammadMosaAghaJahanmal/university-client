...
const Navbar = (props) =>
{
  ...
  const menus = [
    ...
    },
    {
      ...
      mainLink: undefined, 
      links: [
        {name: language.who_we_are, link: "/about/who_we_are"}, 
    ...
    },
    {
      ...
      links: [
        {name: language.student, isTitle: true, subLinks: [
          ...
          {name: language.students_statistic, link: "/student/statistics"},
          {name: language.alumni_support_services, link: "/student/alumni_support_services"},
