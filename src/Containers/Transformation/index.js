...
const Transformation = (props) =>
{
  ...
  const myHero = new URL(serverPath(heros?.find(hero => hero.type === "transformation")?.imagePath || "")).href;

  return (
    <div className={styles.container}>
      <SmallHero title={language.transformation} image={myHero}  bgAnimation={true}/>
